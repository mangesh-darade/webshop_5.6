...
// Fix SameSite cookie issues - apply at multiple points to catch all cookie scenarios 
$hook['post_controller_constructor'] = array(
    'class'    => 'Sma_hooks',
    'function' => 'fix_same_site_cookie',
    'filename' => 'Sma_hooks.php',
    'filepath' => 'hooks'
);
$hook['post_controller_constructor'] = array(
...
// Apply SameSite fix right before output display
